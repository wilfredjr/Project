<?php
    ...
    makeHead("Task Completion Approval");
?>
<?php
                            ...
                            <div class="row">
                                <!-- <div class="col-sm-12 text-right" style="margin-top: 10px; margin-bottom: 10px">
                                    <form class="" method="POST" onsubmit="return approve_all()" action="approve_all.php">
                                        ...
                                        <input type="hidden" name="type" value='task_completion_approval'>
...
<?php
    ...
    $redirect_page="task_completion_approval.php";
...
<script type="text/javascript">
    ...
    $(document).ready(function ()
    {
        dttable=$('#ResultTable').DataTable({
            ...
            "ajax":
            {
                "url":"ajax/task_completion_approval.php",
                "data":function(d)
                {
