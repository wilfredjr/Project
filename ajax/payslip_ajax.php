...
$recordsTotal=$con->myQuery("SELECT COUNT(p.id) FROM payroll_details p INNER JOIN employees e ON p.employee_id=e.id 
                INNER JOIN payroll r ON r.payroll_code=p.payroll_code {$where};",$bindings)->fetchColumn();
