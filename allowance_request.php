                ...
                <div class="box-body">
                  <div class="row">
                    <div class='col-md-12 text-right'>
                      <a href='frm_allowance_request.php' class='btn btn-warning' onclick=''> File New Allowance Request <span class='fa fa-plus'></span> </a>
                    </div>
                    <br/>
                    <br/>
                    <div class="col-sm-12">
...
<?php
  ...
  $redirect_page="allowance_request.php";
...
$(document).ready(function ()
{
    dttable=$('#ResultTable').DataTable({
        ...
        "ajax":
        {
            "url":"ajax/allowance_request.php",
            "data":function(d)
            {
