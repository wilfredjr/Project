<?php
    ...
    $phases=$con->myQuery("SELECT id,name  FROM project_bug_phase")->fetchAll(PDO::FETCH_ASSOC);
    //$department=$con->myQuery("SELECT id, name FROM departments")->fetchAll(PDO::FETCH_ASSOC);
    makeHead("Bug Phase Approval");
?>
<?php
...
<?php
    $request_type="bug_phase_approval";
    $redirect_page="bug_phase_approval.php";
...
<script type="text/javascript">
    ...
    $(document).ready(function ()
    {
        dttable=$('#ResultTable').DataTable({
            ...
            "ajax":
            {
                "url":"ajax/bug_phase_approval.php",
                "data":function(d)
                {
