<?php
    ...
    makeHead("Receivable/Taxable Allowances");
?>
<?php
...
<div class='content-wrapper'>
    <div class='content-header'>
        <h2 class='page-header text-center text-warning'>Receivable/Taxable Form</h2>
    </div>
                    ...
                    <div class='col-sm-12 col-md-8 col-md-offset-2'>
                        <form class='form-horizontal' method='POST' action='save_taxable_allowances.php'>
                            ...
                            <div class='form-group'>
                                ...
                                <div class='col-md-6'>
                                    <input class='text-right form-control number' placeholder='Enter Receivable Allowance Amount' onkeypress="return isNumberKey(event,this)" name='rta_amount' value='<?php echo !empty($data)?$data['rta_amount']:"" ?>'>
                                </div>
                            </div>
                            <div class='form-group'>
                                <label class='col-md-3 control-label'> Tax(%)* </label>
                                <div class='col-md-6'>
                                    <input class='decimal text-right form-control' placeholder='Enter Tax(%)' onkeypress="return isNumberKey(event,this)" name='rta_taxable' value='<?php echo !empty($data)?$data['rta_taxable']:"" ?>' maxlength='3'>
                                </div>
                            </div>
                            <div class='form-group'>
