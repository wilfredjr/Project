...
$project_name=$con->myQuery("SELECT p.id, p.name AS name FROM projects p WHERE p.is_deleted=0 AND p.project_status_id=2")->fetchAll(PDO::FETCH_ASSOC);
...
<div class="content-wrapper">
	...
	<section>
		<div class="content-header">
			<h1 class="page-header text-center">Bug Management</h1>
		</div>
	</section>
