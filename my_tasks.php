...
<div class="content-wrapper">
	...
	<section>
		<div class="content-header">
			<h1 class="page-header text-center">My Tasks Schedule</h1>
		</div>
	</section>
...
<?php
    ...
    require_once("include/modal_submit.php");
...
$(function () {
	data_table=$('#ResultTable').DataTable({
		...
		{"sClass": "text-center", "aTargets": [ -1 ]}],
          "order": [[ 2, "desc" ]],
		"oLanguage": { "sEmptyTaWble": "No Task Found." }
	});
});
