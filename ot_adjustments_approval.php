<?php
  ...
  makeHead("Overtime Adjustments Approval");
?>
...
?>
                  ...
                  <div class="row">
                    <div class="col-sm-12 text-right" style="margin-top: 10px; margin-bottom: 10px">
                        <form class="" method="POST" onsubmit="return approve_all()" action="approve_all.php">
                            ...
                            <input type="hidden" name="type" value='ot_adjustment'>
  ...
  <?php
    ...
    $redirect_page="ot_adjustments_approval.php";
  ...
  $(function () {
        dttable=$('#ResultTable').DataTable({
          "scrollX": true,
            ...
            "ajax":
            {    
                "url":"ajax/ot_adjustments_approval.php",
                "data":function(d)
                {
