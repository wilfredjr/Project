<?php
    ...
    makeHead("Project Development Approval");
?>
<?php
            ...
            <div class="row">
                <form action="" method="" class="form-horizontal" id='frmclear'>
                    <div class='form-group'>
                        ...
                        <label class="col-sm-2 control-label">Project Manager Name </label>
                        <div class='col-sm-3'>
...
<?php
    $request_type="project_development_approval";
    $redirect_page="project_development_approval.php";
    require_once("include/modal_submit_dev.php");
...
<script type="text/javascript">
    ...
    $(document).ready(function ()
    {
        dttable=$('#ResultTable').DataTable({
            ...
            "ajax":
            {
                "url":"ajax/project_development_approval.php",
                "data":function(d)
                {
