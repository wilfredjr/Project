...
?>
  <div class="content-wrapper">
      ...
      <div class='panel-body'>
        <a href="bug_management.php" class="btn btn-default">
                ...
                <div class="box-body">
                  <div class="row">
                    <div class='col-md-12 text-right'>
                      <?php if($usertype==5){?>
                      <a href='frm_bug_management.php?id=<?php echo $_GET['id']?>' class='btn btn-warning'> Add New Task <span class='fa fa-plus'></span> </a>
                    <?php } ?>
                    </div>
                    <div class="col-sm-12">
