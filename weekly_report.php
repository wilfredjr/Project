                          ...
                          <div class="col-sm-9">
		                    ...
		                    <div class="form-group">
		                      <div class="col-sm-9 col-md-offset-3 text-center">
	                            ...
	                            <a href='weekly_report.php' class='btn btn-default'>Cancel</a>
		                      </div>
		                    </div>
		                </form>
                	</div>
                  ...
                  <br/>
                    <table class='table table-bordered table-striped' id='ResultTable'>
                      <thead>
                        ...
                        <th class='text-center date-td'>Week</th>
                        <th class='text-center date-td'>Premium Overtime</th>
                        <th class='text-center date-td'>Worked Hours</th>
                        <th class='text-center date-td'>Extended Hours</th>
                        <th class='text-center date-td'>Late</th>
