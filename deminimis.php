...
<div class="content-wrapper">
    <section>
      	<div class='content-header'>
            <h1 class='page-header text-center text-warning'>De Minimis/Non-taxable Allowance</h1>
        </div>
    </section>
    <section class="content">
        <div class="row">
            ...
            <div class='col-lg-12'>
                <div class='row'>
                    <div class='col-sm-12'>
                        <a href='frm_deminimis.php' class='btn btn-warning btn-flat pull-right'> <span class='fa fa-plus'></span> Create New</a>
                    </div>
                </div>
                <br/>    
