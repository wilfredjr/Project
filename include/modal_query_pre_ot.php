  ...
  <div class="modal" id='modal_pre_ot'>
    <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-body" >
            <div class='' id='comment_table_pre_ot' style=''>
            </div>
          </div>
          <div class='modal-footer'>
            <form method='post' action='save_comments.php'>
              <input type='hidden' name='request_id' value='' id='request_id_pre'>
              <input type='hidden' name='request_type' value='pre_overtime'>
