...
$objPHPExcel->getActiveSheet()->setTitle('Sheet1');
    ...
    $inputFileName = 'files/schedule_of_netpay.xlsx';
   ...
   if(!empty($_GET['pay_code']))
    ...
    while ($data=$data_query->fetch(PDO::FETCH_ASSOC)) 
    {
        ...
        $objPHPExcel->getActiveSheet()->SetCellValue('D'.$row, $data['emp_netpay']);
    ...
    header('Content-Disposition: attachment;filename="schedule_of_netpay.xlsx"');
