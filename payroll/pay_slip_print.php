...
if (!empty($_GET['cd'])) {
    ...
    $getPayDetails=$con->myQuery("SELECT 
        ...
        WHERE p.employee_id = ? AND p.payroll_code=? ", array($_GET['cd'],$_GET['pc']))->fetch(PDO::FETCH_ASSOC);
    ...
    $getGovDeDetails=$con->myQuery("SELECT
        ...
        FROM
        payroll_govde
        WHERE gov_desc = 'HDMF') as hdmf ON details.payroll_code = hdmf.payroll_code AND details.employee_id = hdmf.employee_id", array($_GET['pc'],$_GET['cd']))->fetch(PDO::FETCH_ASSOC);
        ...
        $leave_bal=$con->myQuery("SELECT 
            ...
            WHERE is_cancelled=0 AND is_deleted=0 AND employee_id=?",array($_GET['cd']))->fetchAll(PDO::FETCH_ASSOC);
} else {
                            ...
                            <div class="col-xs-6"  >
                                <div class="col-xs-12 " style="background-color: #FFFFFF; padding: 15px">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-7">
                                            <label class="control-label pull-right"><?php echo number_format($getPayDetails['gross'],2) ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6"  >
                                <div class="col-xs-12 " style="background-color: #FFFFFF; padding: 15px">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-7">  
                                            <label class="control-label pull-right"><?php echo number_format($getPayDetails['withholding_tax'],2) ?></label>
                                        </div>
                                    </div>
                                    <br><br>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-7">
                                            <label class="control-label pull-right"><?php echo number_format($getPayDetails['total_deduction'],2) ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="box box-default">
                        <div class="box-body">
                            <div class="col-xs-12">
                                ...
                                INNER JOIN loan_status ON loan_status.status_id=emp_loans.status_id WHERE employee_id = ? AND loan_status.status_id IN (1, 2)";    
                                $employee_loans = $con->myQuery($complete_query, array($_GET['cd']))->fetchAll(PDO::FETCH_ASSOC);
                                ?>
                                <table class="table">
                                <thead>
                                    <tr>
