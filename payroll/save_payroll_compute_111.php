        ...
        while ($data=$dtr_details->fetch(PDO::FETCH_ASSOC))
        {
            ...
            // GOVERNMENT DEDUCTION
                ...
                // {
                    if ($with_sss == 1)
                    {
                        ...
                        if ($government_setting == 3){
                            $sss_amount = get_sss($basic_salary); 
                        }elseif ($government_setting == 2){
            ...
            // OVERTIME
                ...
                foreach ($period as $key => $date) {
                    ...
                    $sample[$y]=$data_per_week['work_hours']['hours'];
                    $y++;


                    if ($data_per_week['work_hours']['hours'] > 48){
                        $ordinary_ot_hrs    += $data_per_week['work_hours']['hours'] - 48;
                        ...
                        $ot_legal_holiday   = $sdata['overtime_legal_holiday'];
                    ...
                    $for_insert[$x]['overtime']=number_format($totalOvertime, 2, '.', '');
                    // echo "here";
                    // var_dump($totalOvertime);
                    // var_dump($for_insert[$x]['overtime']);
            ...
            //------------------------------------------------------------------------------------
                ...
                if(!empty($taxable_amount)){
                    $for_insert[$x]['tax_allowance']=number_format($taxable_amount, 2, '.', '');
                }else{
