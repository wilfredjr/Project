                ...
                <div class="row">
						<div class='col-md-12'>
                            <div class='col-md-12 '>
                                ...
                                ?>
                                        <form action="save_payroll_compute.php" method="post" style="display:inline" onsubmit="return confirm('Are you to process 13th month?')">
                                ...
                                ?>
                                        <form action=""  style="display:inline"> <!-- FROM PAYROLL DETAILS TABLE -->
                                        ...
                                        <form action=""  style="display:inline"> <!-- SUMMARY WITH CARD NUMBER -->
                                            <button class="btn btn-danger btn-flat" ><span class='fa fa-download'></span> Download Summary </button>
                                        </form>
                                <?php
                                    endif;
                                ?>
