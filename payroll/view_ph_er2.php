	...
	<section class="content">
		...
		<div class="row">
			<div class='col-sm-12 col-md-12'>
				<div class='row'>
                    <div class='col-sm-12'>
						<form method="GET" action="view_ph_er2.php" class="form-horizontal" onsubmit="return filter_search()">
							...
							<div class="form-group">
								<div class='col-md-2 col-md-offset-5 text-right'>
									<button type='submit' class='btn-flat btn btn-danger'  onclick=''><span class="fa fa-search"></span> Filter</button>
								</div>
							</div>
						</form>
					</div>
