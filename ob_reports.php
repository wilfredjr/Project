 ...
 $val=$_SESSION[WEBAPP]['user']['employee_id'];
  ...
  if(!empty($_GET['date_from']) && !empty($_GET['date_to'])){
    ...
    $query="SELECT
            ...
            FROM vw_employees_ob eo
            INNER JOIN employees e
              ON e.id=eo.employee_id INNER JOIN departments on departments.id=e.department_id
           WHERE eo.ob_date BETWEEN :date_from AND :date_to";
    ...
    if(!empty($_GET['employees_id']) && $_GET['employees_id']!='NULL')
    {
      ...
      $query.=" AND eo.employee_id=:employees_id ";
      $order="ORDER BY eo.employee_id";
                  ...
                  <div class='col-md-12'>
                    <table class='table table-bordered table-striped' id='ResultTable'>
                      <thead>
                        ...
                        <th class='text-center time-td'>Time Start</th>
                        <th class='text-center time-td'>Time End</th>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php echo htmlspecialchars(date_format(date_create($row['ob_date']),DATE_FORMAT_PHP)) ?></td>
