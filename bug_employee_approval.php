<?php
    ...
    makeHead("Bug Employee Approval");
?>
<?php
                                    ...
                                    <table id='ResultTable' class='table table-bordered table-striped'>
                                        <thead>
                                            <tr>
                                                ...
                                                <th class='text-center'>Bug Description</th>
...
<?php
    $request_type="bug_employee_approval";
    $redirect_page="bug_employee_approval.php";
...
<script type="text/javascript">
    ...
    $(document).ready(function ()
    {
        dttable=$('#ResultTable').DataTable({
            ...
            "ajax":
            {
                "url":"ajax/bug_employee_approval.php",
                "data":function(d)
                {
