                          ...
                          <div class="col-sm-9">
		                    ...
		                    <div class="form-group">
		                      <div class="col-sm-9 col-md-offset-2 text-center">
		                      	<a href='job_title.php' class='btn btn-default' onclick="return confirm('<?php echo empty($data)?"Cancel creation of new job title?":"Candel modification of job title?" ?>')">Cancel</a>
