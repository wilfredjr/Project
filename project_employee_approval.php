<?php
    ...
    makeHead("Project Employee Approval");
?>
<?php
                ...
                <form action="" method="" class="form-horizontal" id='frmclear'>
                    <div class='form-group'>
                     ...
                     <div class='form-group'>
                        ...
                        <div class='col-sm-3'>
                            <select class='form-control cbo' name='request_id1' id='request_id1' data-placeholder="Select Request Type">
                                <option value=""></option>
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-right" style="margin-top: 10px; margin-bottom: 10px">
                                    <form class="" method="POST" onsubmit="return approve_all()" action="approve_all.php">
                                        ...
                                        <input type="hidden" name="type" value='project_approval_emp'>
...
<?php
    ...
    $redirect_page="project_employee_approval.php";
    require_once("include/modal_reject_project_emp.php");
...
<script type="text/javascript">
    ...
    $(document).ready(function ()
    {
        dttable=$('#ResultTable').DataTable({
            ...
            "ajax":
            {
                "url":"ajax/project_employee_approval.php",
                "data":function(d)
                {
